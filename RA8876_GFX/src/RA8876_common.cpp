...
//**********************************************************************
void RA8876_common::RA8876_SW_Reset(void) {
    unsigned char temp;
...
//**************************************************************//
void RA8876_common::checkWriteFifoNotFull(void) {
    ru16 i;
...
//**************************************************************//
void RA8876_common::checkWriteFifoEmpty(void) {
    ru16 i;
    for (i = 0; i < 10000; i++) // Please according to your usage to modify i value.
    {
...
//**************************************************************//
void RA8876_common::checkReadFifoNotFull(void) {
    ru16 i;
    for (i = 0; i < 10000; i++) // Please according to your usage to modify i value.
    {
...
//**************************************************************//
void RA8876_common::checkReadFifoNotEmpty(void) {
    ru16 i;
    for (i = 0; i < 10000; i++) // //Please according to your usage to modify i value.
    {
...
//**************************************************************//
boolean RA8876_common::checkSdramReady(void) {
    ru32 i;
...
//**************************************************************//
boolean RA8876_common::checkIcReady(void) {
    ru32 i;
    for (i = 0; i < 1000000; i++) { // Please according to your usage to modify i value.
        delayMicroseconds(1);
...
//------------------------------------//----------------------------------*/
boolean RA8876_common::ra8876PllInitial(void) {
...
// Initialize SDRAM
//**************************************************************//
boolean RA8876_common::ra8876SdramInitial(void) {
    ru8 CAS_Latency;
    ru16 Auto_Refresh;
...
//**************************************************************//
void RA8876_common::displayOn(boolean on) {
    unsigned char temp;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdHorizontalWidthVerticalHeight(ru16 width, ru16 height) {
    unsigned char temp;
    temp = (width / 8) - 1;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdHorizontalNonDisplay(ru16 numbers) {
    ru8 temp;
    if (numbers < 8) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdHsyncStartPosition(ru16 numbers) {
    ru8 temp;
    if (numbers < 8) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdHsyncPulseWidth(ru16 numbers) {
    ru8 temp;
    if (numbers < 8) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdVerticalNonDisplay(ru16 numbers) {
    ru8 temp;
    temp = numbers - 1;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdVsyncStartPosition(ru16 numbers) {
    ru8 temp;
    temp = numbers - 1;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::lcdVsyncPulseWidth(ru16 numbers) {
    ru8 temp;
    temp = numbers - 1;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::displayImageStartAddress(ru32 addr) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::displayImageWidth(ru16 width) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::displayWindowStartXY(ru16 x0, ru16 y0) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::canvasImageStartAddress(ru32 addr) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::canvasImageWidth(ru16 width) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::activeWindowXY(ru16 x0, ru16 y0) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::activeWindowWH(ru16 width, ru16 height) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::setPixelCursor(ru16 x, ru16 y) {
    switch (_rotation) {
    case 1:
        swapvals(x, y);
        break;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::linearAddressSet(ru32 addr) {
...
//**************************************************************//
//**************************************************************//
ru8 RA8876_common::vmemReadData(ru32 addr) {
    ru8 vmemData = 0;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::vmemWriteData(ru32 addr, ru8 vmemData) {
    graphicMode(true);
    Memory_Linear_Mode();
    linearAddressSet(addr);
    ramAccessPrepare();
...
//**************************************************************//
//**************************************************************//
ru16 RA8876_common::vmemReadData16(ru32 addr) {
    ru16 vmemData = 0;
...
//**************************************************************//
//**************************************************************//
void RA8876_common::vmemWriteData16(ru32 addr, ru16 vmemData) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_Source0_MemoryStartAddr(ru32 addr) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_Source0_ImageWidth(ru16 width) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_Source0_WindowStartXY(ru16 x0, ru16 y0) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_Source1_MemoryStartAddr(ru32 addr) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_Source1_ImageWidth(ru16 width) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_Source1_WindowStartXY(ru16 x0, ru16 y0) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_DestinationMemoryStartAddr(ru32 addr) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_DestinationImageWidth(ru16 width) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_DestinationWindowStartXY(ru16 x0, ru16 y0) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bte_WindowSize(ru16 width, ru16 height) {
...
//**************************************************************//
void RA8876_common::bte_WindowAlpha(ru8 alpha) {
...
//**************************************************************//
void RA8876_common::pwm_Prescaler(ru8 prescaler) {
    lcdRegDataWrite(RA8876_PSCLR, prescaler); // 84h
}

//**************************************************************//
//**************************************************************//
void RA8876_common::pwm_ClockMuxReg(ru8 pwm1_clk_div, ru8 pwm0_clk_div, ru8 xpwm1_ctrl, ru8 xpwm0_ctrl) {
    lcdRegDataWrite(RA8876_PMUXR, pwm1_clk_div << 6 | pwm0_clk_div << 4 | xpwm1_ctrl << 2 | xpwm0_ctrl); // 85h
}

//**************************************************************//
//**************************************************************//
void RA8876_common::pwm_Configuration(ru8 pwm1_inverter, ru8 pwm1_auto_reload, ru8 pwm1_start, ru8 pwm0_dead_zone, ru8 pwm0_inverter, ru8 pwm0_auto_reload, ru8 pwm0_start) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::pwm0_Duty(ru16 duty) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::pwm0_ClocksPerPeriod(ru16 clocks_per_period) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::pwm1_Duty(ru16 duty) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::pwm1_ClocksPerPeriod(ru16 clocks_per_period) {
...
//**************************************************************//
void RA8876_common::ramAccessPrepare(void) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::backGroundColor16bpp(ru16 color, bool finalize) {
...
//**************************************************************//
void RA8876_common::graphicMode(boolean on) {
    if (on)
...
/* Read a 16bpp pixel                                           */
//**************************************************************//
ru16 RA8876_common::readPixel(int16_t x, int16_t y) {
    return getPixel(x, y);
}
...
//**************************************************************//
void RA8876_common::textMode(boolean on) {
    if (on)
...
//**************************************************************//
void RA8876_common::textColor(ru16 foreground_color, ru16 background_color) {
    check2dBusy();
...
//**************************************************************//
void RA8876_common::setTextCursor(ru16 x, ru16 y) {
...
//***************************************************************//
void RA8876_common::textxy(ru16 x, ru16 y) {
...
//**************************************************************//
void RA8876_common::setTextParameter1(ru8 source_select, ru8 size_select, ru8 iso_select) {
...
//***********************************************************************************************//
void RA8876_common::setTextParameter2(ru8 align, ru8 chroma_key, ru8 width_enlarge, ru8 height_enlarge) {
...
//**************************************************************//
void RA8876_common::genitopCharacterRomParameter(ru8 scs_select, ru8 clk_div, ru8 rom_select, ru8 character_select, ru8 gt_width) {
    if (scs_select == 0)
...
//**************************************************************//
void RA8876_common::putString(ru16 x0, ru16 y0, const char *str) {
    textMode(true);
    while (*str != '\0') {
        write(*str);
        ++str;
...
//**************************************************************//
void RA8876_common::clearStatusLine(uint16_t color) {
...
//**************************************************************//
void RA8876_common::writeStatusLine(ru16 x0, uint16_t fgcolor, uint16_t bgcolor, const char *str) {
...
void RA8876_common::clreol(void) {
    uint16_t tempX = _cursorX;
    uint16_t tempY = _cursorY;
...
void RA8876_common::clreos(void) {
    uint16_t tempX = _cursorX;
    uint16_t tempY = _cursorY;
    clreol();
...
// Support function for VT100: Clear to End Of Line
void RA8876_common::clrbol(void) {
    uint16_t tempX = _cursorX;
    uint16_t tempY = _cursorY;
...
void RA8876_common::clrbos(void) {
    uint16_t tempX = _cursorX;
    uint16_t tempY = _cursorY;
    clrbol();
...
void RA8876_common::clrlin(void) {
    uint16_t tempX = _cursorX;
    uint16_t tempY = _cursorY;
...
void RA8876_common::clearActiveScreen(void) {
...
//**************************************************************//
void RA8876_common::update_xy(void) {
...
//**************************************************************//
void RA8876_common::update_tft(uint8_t data) {
    CGRAM_Start_address(PATTERN1_RAM_START_ADDR);
    textMode(true);
    setTextCursor(_cursorX, _cursorY);
    ramAccessPrepare();
...
//********************************************************************//
void RA8876_common::buildTextScreen(void) {
    switch (_FNTheight) {
    case 16:
        _fontheight = 0;
        break;
...
//********************************************************************//
void RA8876_common::CGRAM_Start_address(uint32_t Addr) {
...
//***************************************************************************//
void RA8876_common::Graphic_cursor_initial(void) {
    unsigned int i;
...
//***************************************************************************//
void RA8876_common::Upload_Graphic_Cursor(uint8_t cursorNum, uint8_t *data) {
    unsigned int i;
...
//***************************************************//
void RA8876_common::Memory_Select_CGRAM(void) { // this may not be right
    unsigned char temp;
...
//***************************************************//
void RA8876_common::Memory_Select_SDRAM(void) {
    unsigned char temp;
    temp = lcdRegDataRead(RA8876_ICR); // 0x03
    temp &= cClrb1;
    temp &= cClrb0; // B
...
//***************************************************//
void RA8876_common::Memory_Select_Graphic_Cursor_RAM(void) {
    unsigned char temp;
    temp = lcdRegDataRead(RA8876_ICR); // 0x03
    temp |= cSetb1;
    temp &= cClrb0;
...
//***************************************************//
void RA8876_common::Memory_XY_Mode(void) {
    /*
...
//***************************************************//
void RA8876_common::Memory_Linear_Mode(void) {
    /*
    Canvas addressing mode
      0: Block mode (X-Y coordination addressing)
      1: linear mode
...
//***************************************************//
void RA8876_common::Enable_Graphic_Cursor(void) {
    /*
...
//***************************************************//
void RA8876_common::Disable_Graphic_Cursor(void) {
    /*
    Graphic Cursor Enable
      0 : Graphic Cursor disable.
      1 : Graphic Cursor enable.
...
//************************************************/
void RA8876_common::Select_Graphic_Cursor_1(void) {
    /*
...
/* Select one of four available graphic cursors  */
//************************************************/
void RA8876_common::Select_Graphic_Cursor_2(void) {
    /*
    Graphic Cursor Selection Bit
    Select one from four graphic cursor types. (00b to 11b)
      00b : Graphic Cursor Set 1.
...
/* Select one of four available graphic cursors  */
//************************************************/
void RA8876_common::Select_Graphic_Cursor_3(void) {
    /*
    Graphic Cursor Selection Bit
    Select one from four graphic cursor types. (00b to 11b)
      00b : Graphic Cursor Set 1.
...
/* Select one of four available graphic cursors  */
//************************************************/
void RA8876_common::Select_Graphic_Cursor_4(void) {
    /*
    Graphic Cursor Selection Bit
    Select one from four graphic cursor types. (00b to 11b)
      00b : Graphic Cursor Set 1.
...
//************************************************/
void RA8876_common::Graphic_Cursor_XY(int16_t WX, int16_t HY) {
    /*
...
//************************************************/
void RA8876_common::Set_Graphic_Cursor_Color_1(unsigned char temp) {
    /*
...
//************************************************/
void RA8876_common::Set_Graphic_Cursor_Color_2(unsigned char temp) {
    /*
...
/* turn on text cursor                           */
//************************************************/
void RA8876_common::Enable_Text_Cursor(void) {
    /*
    Text Cursor Enable
      0 : Disable.
      1 : Enable.
...
//************************************************/
void RA8876_common::Disable_Text_Cursor(void) {
    /*
    Text Cursor Enable
      0 : Disable.
      1 : Enable.
...
//************************************************/
void RA8876_common::Enable_Text_Cursor_Blinking(void) {
    /*
...
//************************************************/
void RA8876_common::Disable_Text_Cursor_Blinking(void) {
    /*
    Text Cursor Blinking Enable
      0 : Disable.
      1 : Enable.
...
//************************************************/
void RA8876_common::Blinking_Time_Frames(unsigned char temp) {
    /*
...
//************************************************/
void RA8876_common::Text_Cursor_H_V(unsigned short WX, unsigned short HY) {
    /*
    REG[3Eh]
...
//************************************************/
void RA8876_common::Color_Bar_ON(void) {
    /*
...
//************************************************/
void RA8876_common::Color_Bar_OFF(void) {
    /*
    Display Test Color Bar
      0b: Disable.
      1b: Enable.
...
//**************************************************************//
void RA8876_common::drawLine(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color) {
    x0 += _originx;
    x1 += _originx;
    y0 += _originy;
    y1 += _originy;
...
//**************************************************************//
void RA8876_common::drawSquare(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color) {
    x0 += _originx;
    x1 += _originx;
    y1 += _originy;
    y1 += _originy;
...
// x1,y1 is lower right end corner
//**************************************************************//
void RA8876_common::drawSquareFill(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 color) {
...
//**************************************************************//
void RA8876_common::drawCircleSquare(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 xr, ru16 yr, ru16 color) {
    x0 += _originx;
    x1 += _originx;
    y1 += _originy;
    y1 += _originy;
...
// yr is the minor radius of corner (vertical)
//**************************************************************//
void RA8876_common::drawCircleSquareFill(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 xr, ru16 yr, ru16 color) {
    x0 += _originx;
    x1 += _originx;
    y1 += _originy;
    y1 += _originy;
...
//**************************************************************//
void RA8876_common::drawTriangle(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 x2, ru16 y2, ru16 color) {
    x0 += _originx;
    x1 += _originx;
    x2 += _originx;
    y0 += _originy;
...
// x2,y2 is triangle end point
//**************************************************************//
void RA8876_common::drawTriangleFill(ru16 x0, ru16 y0, ru16 x1, ru16 y1, ru16 x2, ru16 y2, ru16 color) {
    x0 += _originx;
    x1 += _originx;
    x2 += _originx;
    y0 += _originy;
...
//**************************************************************//
void RA8876_common::drawCircle(ru16 x0, ru16 y0, ru16 r, ru16 color) {
    x0 += _originx;
    y0 += _originy;
...
//**************************************************************//
void RA8876_common::drawEllipse(ru16 x0, ru16 y0, ru16 xr, ru16 yr, ru16 color) {
    x0 += _originx;
    y0 += _originy;
...
//**************************************************************//
void RA8876_common::drawEllipseFill(ru16 x0, ru16 y0, ru16 xr, ru16 yr, ru16 color) {
    x0 += _originx;
    y0 += _originy;
...
// Scroll Screen up
//*************************************************************//
void RA8876_common::scroll(void) {                                                          // No arguments for now
...
// Scroll Screen down
//*************************************************************//
void RA8876_common::scrollDown(void) {                                                      // No arguments for now
...
//*************************************************************//
uint32_t RA8876_common::boxPut(uint32_t vPageAddr, uint16_t x0, uint16_t y0,
...
//*************************************************************//
uint32_t RA8876_common::boxGet(uint32_t vPageAddr, uint16_t x0, uint16_t y0,
                               uint16_t x1, uint16_t y1,
                               uint16_t dx0, uint16_t dy0) {
...
//**************************************************************//
void RA8876_common::bteMemoryCopy(ru32 s0_addr, ru16 s0_image_width, ru16 s0_x, ru16 s0_y,
...
//**************************************************************//
void RA8876_common::bteMemoryCopyWithROP(
...
//**************************************************************//
void RA8876_common::bteMemoryCopyWithChromaKey(
    ru32 s0_addr, ru16 s0_image_width, ru16 s0_x, ru16 s0_y,
    ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y,
...
//**************************************************************//
void RA8876_common::bteMemoryCopyWindowAlpha(
    ru32 s0_addr, ru16 s0_image_width, ru16 s0_x, ru16 s0_y,
    ru32 s1_addr, ru16 s1_image_width, ru16 s1_x, ru16 s1_y,
    ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y,
...
//**************************************************************//
void RA8876_common::bteMpuWriteWithChromaKey(ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y, ru16 width,
...
//**************************************************************//
//**************************************************************//
void RA8876_common::bteMpuWriteColorExpansionData(ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y, ru16 width,
...
// write data after setting, using lcdDataWrite() or lcdDataWrite16bbp()
//**************************************************************//
void RA8876_common::bteMpuWriteColorExpansion(ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y, ru16 width,
...
//**************************************************************//
void RA8876_common::bteMpuWriteColorExpansionWithChromaKeyData(ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y, ru16 width,
                                                               ru16 height, ru16 foreground_color, ru16 background_color, const unsigned char *data) {
    ru16 i, j;
    check2dBusy();
    graphicMode(true);
...
// write data after setting, using lcdDataWrite() or lcdDataWrite16bbp()
//**************************************************************//
void RA8876_common::bteMpuWriteColorExpansionWithChromaKey(ru32 des_addr, ru16 des_image_width, ru16 des_x, ru16 des_y, ru16 width,
                                                           ru16 height, ru16 foreground_color, ru16 background_color) {
    check2dBusy();
    graphicMode(true);
    bte_DestinationMemoryStartAddr(des_addr);
...
//**************************************************************//
//**************************************************************//
void RA8876_common::btePatternFill(ru8 p8x8or16x16, ru32 s0_addr, ru16 s0_image_width, ru16 s0_x, ru16 s0_y,
...
//**************************************************************//
//**************************************************************//
void RA8876_common::btePatternFillWithChromaKey(ru8 p8x8or16x16, ru32 s0_addr, ru16 s0_image_width, ru16 s0_x, ru16 s0_y, ru32 des_addr,
...
//**************************************************************//
void RA8876_common::setSerialFlash4BytesMode(ru8 scs_select) {
    if (scs_select == 0) {
...
//**************************************************************//
void RA8876_common::dma_24bitAddressBlockMode(ru8 scs_select, ru8 clk_div, ru16 x0, ru16 y0, ru16 width, ru16 height, ru16 picture_width, ru32 addr) {
    if (scs_select == 0)
...
/* scs = 0 : select scs0, scs = 1 : select scs1, */
//**************************************************************//
void RA8876_common::dma_32bitAddressBlockMode(ru8 scs_select, ru8 clk_div, ru16 x0, ru16 y0, ru16 width, ru16 height, ru16 picture_width, ru32 addr) {
    if (scs_select == 0)
...
//[2Ah][2Bh][2Ch][2Dh]=========================================================================
void RA8876_common::PIP_Display_Start_XY(unsigned short WX, unsigned short HY) {
    /*
...
//[2Eh][2Fh][30h][31h]=========================================================================
void RA8876_common::PIP_Image_Start_Address(unsigned long Addr) {
...
//[32h][33h]=========================================================================
void RA8876_common::PIP_Image_Width(unsigned short WX) {
    /*
    Unit: Pixel.
...
//[34h][35h][36h][37h]=========================================================================
void RA8876_common::PIP_Window_Image_Start_XY(unsigned short WX, unsigned short HY) {
    /*
...
//[38h][39h][3Ah][3Bh]=========================================================================
void RA8876_common::PIP_Window_Width_Height(unsigned short WX, unsigned short HY) {
    /*
    Unit: Pixel.
...
void RA8876_common::Enable_PIP1(void) {
    /*
...
void RA8876_common::Disable_PIP1(void) {
    /*
    PIP 1 window Enable/Disable
    0 : PIP 1 window disable.
    1 : PIP 1 window enable
...
void RA8876_common::Enable_PIP2(void) {
    /*
...
// Turn off PIP window 1
void RA8876_common::Disable_PIP2(void) {
    /*
    PIP 2 window Enable/Disable
    0 : PIP 2 window disable.
    1 : PIP 2 window enable
...
void RA8876_common::Select_PIP1_Parameter(void) {
    /*
...
void RA8876_common::Select_PIP2_Parameter(void) {
    /*
    0: To configure PIP 1¡Šs parameters.
    1: To configure PIP 2¡Šs parameters..
    */
...
void RA8876_common::Select_LCD_Sync_Mode(void) {
    /*
...
void RA8876_common::Select_LCD_DE_Mode(void) {
    /*
    To Control panel's synchronous signals
    0: Sync Mode: Enable XVSYNC, XHSYNC, XDE
    1: DE Mode: Only XDE enable, XVSYNC & XHSYNC in idle state
...
//[11h]=========================================================================
void RA8876_common::Select_PIP1_Window_8bpp(void) {
    /*
...
void RA8876_common::Select_PIP1_Window_16bpp(void) {
    /*
    PIP 1 Window Color Depth Setting
    00b: 8-bpp generic TFT, i.e. 256 colors.
    01b: 16-bpp generic TFT, i.e. 65K colors.
...
void RA8876_common::Select_PIP1_Window_24bpp(void) {
    /*
    PIP 1 Window Color Depth Setting
    00b: 8-bpp generic TFT, i.e. 256 colors.
    01b: 16-bpp generic TFT, i.e. 65K colors.
...
void RA8876_common::Select_PIP2_Window_8bpp(void) {
    /*
...
void RA8876_common::Select_PIP2_Window_16bpp(void) {
    /*
    PIP 2 Window Color Depth Setting
    00b: 8-bpp generic TFT, i.e. 256 colors.
    01b: 16-bpp generic TFT, i.e. 65K colors.
...
void RA8876_common::Select_PIP2_Window_24bpp(void) {
    /*
    PIP 2 Window Color Depth Setting
    00b: 8-bpp generic TFT, i.e. 256 colors.
    01b: 16-bpp generic TFT, i.e. 65K colors.
...
void RA8876_common::selectScreen(uint32_t screenPage) {
    check2dBusy();
...
// Save current screen page parameters
void RA8876_common::saveTFTParams(tftSave_t *screenSave) {
...
// Restore selected screen page parameters
void RA8876_common::restoreTFTParams(tftSave_t *screenSave) {
...
void RA8876_common::useCanvas(boolean on) {
    if (on) {
...
void RA8876_common::updateScreen() {
...
// Setup text cursor
void RA8876_common::cursorInit(void) {
    _cursorXsize = _FNTwidth;
...
*/
/**************************************************************************/
void RA8876_common::setCursor(int16_t x, int16_t y, bool autocenter) {
    if (_use_default) {
        // setTextCursor(x, y);
        // return;
    }
...
*/
/**************************************************************************/
void RA8876_common::getCursor(int16_t &x, int16_t &y) {
    uint8_t t1, t2, t3, t4;
...
int16_t RA8876_common::getCursorX(void) {
    // if (_portrait && _use_default) return _cursorY;
    return _cursorX;
}

int16_t RA8876_common::getCursorY(void) {
    // if (_portrait && _use_default) return _cursorX;
    return _cursorY;
}

// Set Graphic Mode Margins (pixel based)
void RA8876_common::setMargins(uint16_t xl, uint16_t yt, uint16_t xr, uint16_t yb) {
    _scrollXL = xl;
    _scrollYT = yt;
    _scrollXR = xr;
    _scrollYB = yb;
...
void RA8876_common::setTMargins(uint16_t xl, uint16_t yt, uint16_t xr, uint16_t yb) {
...
void RA8876_common::fillStatusLine(uint16_t color) {
...
//**************************************************************//
void RA8876_common::setTextColor(uint16_t color) {
...
//**************************************************************//
//**************************************************************//
void RA8876_common::setBackGroundColor(uint16_t color) {
    backGroundColor16bpp(color);
}

// Set text foreground + background colors
void RA8876_common::setTextColor(uint16_t fgc, uint16_t bgc) {
    if (_use_ili_font) {
...
void RA8876_common::tftRawWrite(uint8_t data) {
    rawPrint(data);
}

// Send a string to the status line
void RA8876_common::printStatusLine(uint16_t x0, uint16_t fgColor, uint16_t bgColor, const char *text) {
...
uint8_t RA8876_common::fontLoadMEM(char *fontsrc) {
...
uint8_t RA8876_common::fontLoad(char *fontfile) {
...
void RA8876_common::setFontSource(uint8_t source) {
...
boolean RA8876_common::setFontSize(uint8_t scale, boolean runflag) {
    switch (scale) {
...
void RA8876_common::setCursorMode(boolean mode) {
...
void RA8876_common::setCursorType(uint8_t type) {
...
void RA8876_common::setCursorBlink(boolean onOff) {
    if (onOff)
...
void RA8876_common::fillRectHGradient(int16_t x, int16_t y, int16_t w, int16_t h,
...
void RA8876_common::fillRectVGradient(int16_t x, int16_t y, int16_t w, int16_t h,
                                      uint16_t color1, uint16_t color2) {
    x += _originx;
    y += _originy;
    int16_t x_end = x + w - 1;
...
void RA8876_common::writeRotatedRect(int16_t x, int16_t y, int16_t w, int16_t h, const uint16_t *pcolors) {
...
void RA8876_common::writeRect8BPP(int16_t x, int16_t y, int16_t w, int16_t h,
...
void RA8876_common::writeRect4BPP(int16_t x, int16_t y, int16_t w, int16_t h,
                                  const uint8_t *pixels,
                                  const uint16_t *palette) {
...
void RA8876_common::writeRect2BPP(int16_t x, int16_t y, int16_t w, int16_t h,
                                  const uint8_t *pixels,
                                  const uint16_t *palette) {
    // Simply call through our helper
...
void RA8876_common::writeRect1BPP(int16_t x, int16_t y, int16_t w, int16_t h,
                                  const uint8_t *pixels,
                                  const uint16_t *palette) {
    // Simply call through our helper
...
//  the work.
void RA8876_common::writeRectNBPP(int16_t x, int16_t y, int16_t w, int16_t h,
...
void RA8876_common::drawRoundRect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t xr, uint16_t yr, uint16_t color) {
    x += _originx;
    y += _originy;
    int16_t x_end = x + w - 1;
    int16_t y_end = y + h - 1;
...
void RA8876_common::fillRoundRect(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t xr, uint16_t yr, uint16_t color) {
    x += _originx;
    y += _originy;
    int16_t x_end = x + w - 1;
    int16_t y_end = y + h - 1;
...
// Draw a filled circle
void RA8876_common::fillCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color) {
    drawCircleFill(x0, y0, r, color);
}

// Draw a filled ellipse.
void RA8876_common::fillEllipse(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint16_t color) {
    drawEllipseFill(xCenter, yCenter, longAxis, shortAxis, color);
}

// Draw a filled triangle
void RA8876_common::fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color) {
    drawTriangleFill(x0, y0, x1, y1, x2, y2, color);
}

// Setup graphic mouse cursor
void RA8876_common::gCursorSet(boolean gCursorEnable, uint8_t gcursortype, uint8_t gcursorcolor1, uint8_t gcursorcolor2) {
    if (!gCursorEnable)
...
void RA8876_common::gcursorxy(uint16_t gcx, uint16_t gcy) {
    Graphic_Cursor_XY(gcx, gcy);
}

// Scroll the screen up one text line
void RA8876_common::scrollUp(void) {
    scroll();
}
...
/*uint32_t RA8876_common::tft_boxPut(uint32_t vPageAddr, uint16_t x0, uint16_t y0,
...
uint32_t RA8876_common::tft_boxGet(uint32_t vPageAddr, uint16_t x0, uint16_t y0,
          uint16_t x1, uint16_t y1, uint16_t dx0, uint16_t dy0) {
...
void RA8876_common::_fontWrite(const uint8_t *buffer, uint16_t len) {
    if (_use_default) {
...
// Draw a character
void RA8876_common::drawChar(int16_t x, int16_t y, unsigned char c,
...
void RA8876_common::setFont(const ILI9341_t3_font_t &f) {
    _use_default = 0;
...
void RA8876_common::setFont(const GFXfont *f) {
    _use_default = 0;
...
void RA8876_common::drawFontChar(unsigned int c) {
...
int16_t RA8876_common::strPixelLen(const char *str) {
...
void RA8876_common::charBounds(char c, int16_t *x, int16_t *y,
...
void RA8876_common::getTextBounds(const uint8_t *buffer, uint16_t len, int16_t x, int16_t y,
...
void RA8876_common::getTextBounds(const char *str, int16_t x, int16_t y,
                                  int16_t *x1, int16_t *y1, uint16_t *w, uint16_t *h) {
...
void RA8876_common::getTextBounds(const String &str, int16_t x, int16_t y,
                                  int16_t *x1, int16_t *y1, uint16_t *w, uint16_t *h) {
    if (str.length() != 0) {
...
void RA8876_common::drawFontBits(bool opaque, uint32_t bits, uint32_t numbits, int32_t x, int32_t y, uint32_t repeat) {
...
void RA8876_common::drawGFXFontChar(unsigned int c) {
...
bool RA8876_common::gfxFontLastCharPosFG(int16_t x, int16_t y) {
...
void RA8876_common::setTextSize(uint8_t s_x, uint8_t s_y) {
    textsize_x = (s_x > 0) ? s_x : 1;
    textsize_y = (s_y > 0) ? s_y : 1;
    _gfx_last_char_x_write = 0; // Don't use cached data here
}

void RA8876_common::drawFontPixel(uint8_t alpha, uint32_t x, uint32_t y) {
...
void RA8876_common::Pixel(int16_t x, int16_t y, uint16_t color) {
    x += _originx;
    y += _originy;
...
uint32_t RA8876_common::fetchbit(const uint8_t *p, uint32_t index) {
    if (p[index >> 3] & (1 << (7 - (index & 7))))
        return 1;
    return 0;
}

uint32_t RA8876_common::fetchbits_unsigned(const uint8_t *p, uint32_t index, uint32_t required) {
    uint32_t val = 0;
    do {
        uint8_t b = p[index >> 3];
...
uint32_t RA8876_common::fetchbits_signed(const uint8_t *p, uint32_t index, uint32_t required) {
...
uint32_t RA8876_common::fetchpixel(const uint8_t *p, uint32_t index, uint32_t x) {
    // The byte
    uint8_t b = p[index >> 3];
...
*/
/**************************************************************************/
void RA8876_common::setActiveWindow(int16_t XL, int16_t XR, int16_t YT, int16_t YB) {
...
*/
/**************************************************************************/
void RA8876_common::setActiveWindow(void) {
    _activeWindowXL = 0;
    _activeWindowXR = _width;
    _activeWindowYT = 0;
    _activeWindowYB = _height;
...
*/
/**************************************************************************/
void RA8876_common::_updateActiveWindow(bool full) {
    if (full) {
        // X
        activeWindowXY(0, 0);
        activeWindowWH(_width, _height);
...
*/
/**************************************************************************/
void RA8876_common::_textPosition(int16_t x, int16_t y, bool update) {
    lcdRegDataWrite(RA8876_F_CURX0, x, false);      // 63h
    lcdRegDataWrite(RA8876_F_CURX1, x >> 8, false); // 64h
    lcdRegDataWrite(RA8876_F_CURY0, y, false);      // 65h
    lcdRegDataWrite(RA8876_F_CURY1, y >> 8, true);  // 66h
...
void RA8876_common::_setFNTdimensions(uint8_t index) {
...
size_t RA8876_common::write(uint8_t c) {
    return write(&c, 1);
}

size_t RA8876_common::write(const uint8_t *buffer, size_t size) {
    if (_use_default) {
        size_t cb = size;
        // Lets try to handle some of the special font centering code that was done for default fonts.
        if (_absoluteCenter || _relativeCenter) {
...
//************************************************//
size_t RA8876_common::rawPrint(uint8_t text) {
    update_tft(text);
    _cursorX += (_FNTwidth * _scaleX);
    switch (_FNTwidth) {
    case 12: // Font width is 12, 1024 / 12 =  85.3, have to
...
*/
/**************************************************************************/
uint8_t RA8876_common::getRotation() {
    return _rotation;
}
...
/* Turn RA8876 text rotate mode ON/OFF (True = ON)              */
//**************************************************************//
void RA8876_common::textRotate(boolean on) {
    if (on) {
...
void RA8876_common::MemWrite_Left_Right_Top_Down(void) {
...
void RA8876_common::MemWrite_Right_Left_Top_Down(void) {
    /* Host Write Memory Direction (Only for Graphic Mode)
...
void RA8876_common::MemWrite_Top_Down_Left_Right(void) {
    /* Host Write Memory Direction (Only for Graphic Mode)
...
void RA8876_common::MemWrite_Down_Top_Left_Right(void) {
    /* Host Write Memory Direction (Only for Graphic Mode)
...
void RA8876_common::VSCAN_T_to_B(void) {
    /*
...
void RA8876_common::VSCAN_B_to_T(void) {
    /*
    Vertical Scan direction
    0 : From Top to Bottom
    1 : From bottom to Top
...
/**************************************************************************/
/*!
  The FT5206 Capacitive Touch driver uses a different INT pin than RA8876_common
...
*/
/**************************************************************************/
void RA8876_common::useCapINT(const uint8_t INTpin, const uint8_t RSTPin) {
    _intCTSPin = INTpin;
    _rstCTSPin = RSTPin;
...
*/
/**************************************************************************/
void RA8876_common::cts_isr(void) {
    _FT5206_INT = true;
}
...
*/
/**************************************************************************/
void RA8876_common::enableCapISR(bool force) {
...
*/
/**************************************************************************/
void RA8876_common::_disableCapISR(void) {
    if (_useISR) {
...
*/
/**************************************************************************/
void RA8876_common::printTSRegisters(Print &pr, uint8_t start, uint8_t count) {
...
*/
/**************************************************************************/
bool RA8876_common::touched(bool safe) {
...
void RA8876_common::setTouchLimit(uint8_t limit) {
    if (limit > 5)
        limit = 5; // max 5 allowed
    _maxTouch = limit;
}

uint8_t RA8876_common::getTouchLimit(void) {
    return _maxTouch;
}
...
void RA8876_common::_initializeFT5206(void) {
    uint8_t i;
    for (i = 0x80; i < 0x89; i++) {
...
*/
/**************************************************************************/
void RA8876_common::_sendRegFT5206(uint8_t reg, const uint8_t val) {
    _wire->beginTransmission(_ctpAdrs);
    _wire->write(reg);
    _wire->write(val);
    _wire->endTransmission(_ctpAdrs);
...
*/
/**************************************************************************/
void RA8876_common::updateTS(void) {
...
*/
/**************************************************************************/
uint8_t RA8876_common::getTScoordinates(uint16_t (*touch_coordinates)[2]) {
    uint8_t i;
...
*/
/**************************************************************************/
uint8_t RA8876_common::getTouchState(void) {
...
*/
/**************************************************************************/
uint8_t RA8876_common::getTouches(void) {
    return _currentTouches;
}
...
*/
/**************************************************************************/
uint8_t RA8876_common::getGesture(void) {
